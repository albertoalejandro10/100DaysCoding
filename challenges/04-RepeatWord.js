...
let repeat = parseInt(prompt('Ingresa el numero de veces que se repetira una palabra', 0));
let word = prompt('Ingresa la palabra a iterar');

function RepeatWord(repeat, word){
